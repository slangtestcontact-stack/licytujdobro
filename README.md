...
Najważniejsze instrukcje aktualizacji: `UPGRADE_TO_1.5.md`. Konfiguracja zdjęć w chmurze: `CLOUDFLARE_R2_SETUP.md`. Zestaw wdrożonych zmian: `IMPLEMENTED_IMPROVEMENTS_1.5.md`.
